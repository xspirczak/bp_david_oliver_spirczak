    ...
    return (
        <div className="flex flex-col items-center justify-center mb-6">
            ...
            <p className="text-custom-dark-blue font-light md:text-fontSize16 text-fontSize12 text-center px-2 sm:px-6">Nahrať
                ...
                formáte <span className="font-semibold">(.json)</span> alebo samotným vložením kľúča v JSON formáte do
                vstupného poľa
                nižšie.</p>
            <motion.div
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit} encType="multipart/form-data">
                        ...
                        <div className="flex justify-center mb-5">
                            <label className="inline-flex items-center cursor-pointer">
                                ...
                                <span
                                    className="ms-3 text-fontSize16 font-semibold text-custom-dark-blue">{inputType ? (
                                    "Súbor ako vstup"
                                ) : (
                                    "Manuálny vstup"
                                )}</span>
                                    ...
                                    <div className="border rounded-lg border-custom-dark-blue p-5">
                                        {Object.entries(data).map(([key, values]) => (
                                            <div key={key} className="mb-2 flex items-center space-x-2">
                                                <span
                                                    className="font-bold sm:text-fontSize16 text-fontSize12">{key}:</span>
                                                <span
