    ...
    return (
        <section className="bg-gradient-to-r from-blue-500 to-cyan-200 min-h-screen flex justify-center px-4 py-12">
            <motion.div
                ...
                className="bg-white shadow-xl rounded-3xl w-full md:w-3/4 max-w-5xl p-8 md:p-14 space-y-8 h-fit">
            <div className="flex items-center space-x-4">
                ...
                <p className="text-sm text-gray-500 pt-4 border-t">
                    V prípade otázok ohľadom súkromia nás môžete kontaktovať <ScrollLink to="/contact" className="underline font-medium hover:text-custom-dark-blue-hover transition">tu </ScrollLink>.
                </p>
            </motion.div>
        </section>
    );
