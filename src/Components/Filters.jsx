...
const SearchBar = ({ filters, onFilterChange }) => {
    const languageOptions = [
        { value: 'Anglický', label: 'Anglický' },
        { value: 'Francúzsky', label: 'Francúzsky' },
        { value: 'Nemecký', label: 'Nemecký' },
    ];
            ...
            <div className="space-y-6">
                <div className="relative sm:w-2/3 w-full flex mx-auto">
                    <input
                        ...
                        className="w-full px-6 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-dark-blue focus:border-transparent transition-all duration-200 text-gray-700 placeholder-gray-400"
                    />
                    <svg className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400" width="20"
                ...
                <div className="grid sm:flex justify-center gap-6">
                        ...
                        <div className="relative group items-center justify-center flex">
                            ...
                            >
                                <svg width="41" height="44" viewBox="0 0 41 44" fill="none"
                                    ...
                                    <path
                                        d="M12.1979 31.5334H10.5715C10.1224 31.5334 9.7583 31.8618 9.7583 32.2668C9.7583 32.6718 10.1224 33.0001 10.5715 33.0001H12.1979C12.647 33.0001 13.0111 32.6718 13.0111 32.2668C13.0111 31.8618 12.647 31.5334 12.1979 31.5334Z"
                                        fill="white"/>
                                    <path
                                        d="M34.9678 31.5334H15.4509C15.0018 31.5334 14.6377 31.8618 14.6377 32.2668C14.6377 32.6718 15.0018 33.0001 15.4509 33.0001H34.9678C35.4169 33.0001 35.781 32.6718 35.781 32.2668C35.781 31.8618 35.4169 31.5334 34.9678 31.5334Z"
                                        fill="white"/>
                                    <path
                                        d="M12.1979 27.1335H10.5715C10.1224 27.1335 9.7583 27.4619 9.7583 27.8669C9.7583 28.2719 10.1224 28.6002 10.5715 28.6002H12.1979C12.647 28.6002 13.0111 28.2719 13.0111 27.8669C13.0111 27.4619 12.647 27.1335 12.1979 27.1335Z"
                                        fill="white"/>
                                    <path
                                        d="M34.9678 27.1335H15.4509C15.0018 27.1335 14.6377 27.4619 14.6377 27.8669C14.6377 28.2719 15.0018 28.6002 15.4509 28.6002H34.9678C35.4169 28.6002 35.781 28.2719 35.781 27.8669C35.781 27.4619 35.4169 27.1335 34.9678 27.1335Z"
                                        fill="white"/>
                                    <path
                                        d="M12.1979 22.7334H10.5715C10.1224 22.7334 9.7583 23.0617 9.7583 23.4667C9.7583 23.8717 10.1224 24.2001 10.5715 24.2001H12.1979C12.647 24.2001 13.0111 23.8717 13.0111 23.4667C13.0111 23.0617 12.647 22.7334 12.1979 22.7334Z"
                                        fill="white"/>
                                    <path
                                        d="M34.9678 22.7334H15.4509C15.0018 22.7334 14.6377 23.0617 14.6377 23.4667C14.6377 23.8717 15.0018 24.2001 15.4509 24.2001H34.9678C35.4169 24.2001 35.781 23.8717 35.781 23.4667C35.781 23.0617 35.4169 22.7334 34.9678 22.7334Z"
                                        fill="white"/>
                                    <path
                                        d="M12.1979 18.3333H10.5715C10.1224 18.3333 9.7583 18.6616 9.7583 19.0666C9.7583 19.4716 10.1224 19.7999 10.5715 19.7999H12.1979C12.647 19.7999 13.0111 19.4716 13.0111 19.0666C13.0111 18.6616 12.647 18.3333 12.1979 18.3333Z"
                                        fill="white"/>
                                    <path
                                        d="M34.9678 18.3333H15.4509C15.0018 18.3333 14.6377 18.6616 14.6377 19.0666C14.6377 19.4716 15.0018 19.7999 15.4509 19.7999H34.9678C35.4169 19.7999 35.781 19.4716 35.781 19.0666C35.781 18.6616 35.4169 18.3333 34.9678 18.3333Z"
                                        fill="white"/>
                                    <path
                                        d="M12.1979 13.9333H10.5715C10.1224 13.9333 9.7583 14.2617 9.7583 14.6667C9.7583 15.0717 10.1224 15.4 10.5715 15.4H12.1979C12.647 15.4 13.0111 15.0717 13.0111 14.6667C13.0111 14.2617 12.647 13.9333 12.1979 13.9333Z"
                                        fill="white"/>
                                    <path
                                        d="M34.9678 13.9333H15.4509C15.0018 13.9333 14.6377 14.2617 14.6377 14.6667C14.6377 15.0717 15.0018 15.4 15.4509 15.4H34.9678C35.4169 15.4 35.781 15.0717 35.781 14.6667C35.781 14.2617 35.4169 13.9333 34.9678 13.9333Z"
                                        fill="white"/>
                                    <path
                                        d="M40.6497 10.9538C40.6456 10.8895 40.6317 10.8261 40.6082 10.7653C40.5992 10.7419 40.5927 10.7191 40.5814 10.6964C40.5418 10.6167 40.4867 10.5439 40.4187 10.4815L29.0338 0.214867C28.9647 0.153542 28.884 0.103858 28.7956 0.0682C28.7704 0.0579333 28.7452 0.0520667 28.7199 0.044C28.6519 0.0229167 28.5811 0.0100833 28.5093 0.00586667C28.4955 0.00806667 28.4801 0 28.4622 0H5.69243C5.24334 0 4.87923 0.32835 4.87923 0.733333V2.93333H0.813205C0.364112 2.93333 0 3.26168 0 3.66667V43.2667C0 43.6717 0.364112 44 0.813205 44H34.9678C35.4169 44 35.781 43.6717 35.781 43.2667V39.6H39.847C40.2961 39.6 40.6602 39.2717 40.6602 38.8667V11C40.6602 10.9839 40.6513 10.9699 40.6497 10.9538ZM29.2754 2.5036L37.884 10.2667H29.2754V2.5036ZM34.1546 42.5333H1.62641V4.4H4.87923V38.8667C4.87923 39.2717 5.24334 39.6 5.69243 39.6H34.1546V42.5333ZM39.0338 38.1333H6.50564V1.46667H27.649V11C27.649 11.405 28.0131 11.7333 28.4622 11.7333H39.0338V38.1333Z"
                                        fill="white"/>
                                    <path
                    ...
                    <div className="mt-8 grid justify-center">
                        <h3 className="text-fontSize16 font-semibold text-custom-dark-blue mb-4 ">Interval rokov</h3>
                        <div className="px-4">
                            <MultiRangeSlider min={1400} max={2025} onChange={handleRangeChange}/>
                        </div>
                    </div>
                ...
                <div className="grid sm:flex justify-center gap-6">
                    ...
                    <div className="sm:gap-6 gap-2">
                        <div className="w-full">
                            <label className="block mb-2 font-semibold text-fontSize16 text-custom-dark-blue">Jazyk
                                dokumentu</label>
                            <Select
                                isMulti
                                name="languageOfDoc"
                                ...
                                value={languageOptions.filter(option => filters.language?.includes(option.value))}
                                onChange={handleLanguageChange}
                                placeholder="Vyber jazyka..."
                            />
                        </div>
                    </div>
                    <div className="sm:gap-6 gap-2">
                        <div className="w-full">
                            <label className="block mb-2 font-semibold text-fontSize16 text-custom-dark-blue">Pôvod
                                dokumentu</label>
                            <Select
                                isMulti
                                name="sourceOfDoc"
                                ...
                                className="basic-multi-select"
                                classNamePrefix="select"
                                value={sourceOptions.filter(option => filters.source?.includes(option.value))}
                                onChange={handleSourceChange}
                                placeholder="Vyber pôvodu..."
                            />
                        </div>
                    </div>
                    <div className="sm:gap-6 gap-2">
                        <div className="w-full">
                            <label className="block mb-2 font-semibold text-fontSize16 text-custom-dark-blue">Krajina pôvodu
                                dokumentu</label>
                            <Select
                                isMulti
                                name="countryOfDoc"
                                ...
                                className="basic-multi-select"
                                classNamePrefix="select"
                                value={countryOptions.filter(option => filters.country?.includes(option.value))}
                                onChange={handleCountryChange}
                                placeholder="Vyber krajiny..."
                            />
                        </div>
                    </div>
                </div>
